...
void main()
{
    ...
    _TMP5 = OutputSize/(InputSize*2.00000000E+00);
    ...
    _TMP4._one_texel = vec2(float((1.00000000E+00/(TextureSize*2.00000000E+00)).x), float((1.00000000E+00/(TextureSize*2.00000000E+00)).y));

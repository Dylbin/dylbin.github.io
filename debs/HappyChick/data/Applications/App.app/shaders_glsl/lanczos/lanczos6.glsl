...
void main()
{
    ...
    _r0007 = _v0007.x*MVPMatrix[0];
    _r0007 = _r0007 + _v0007.y*MVPMatrix[1];
    _r0007 = _r0007 + _v0007.z*MVPMatrix[2];
    _r0007 = _r0007 + _v0007.w*MVPMatrix[3];
    _oPosition1 = vec4(float(_r0007.x), float(_r0007.y), float(_r0007.z), float(_r0007.w));
    _oColor = COLOR;
...
void main()
{
    ...
    FragColor = vec4(float(_OUT._color.x), float(_OUT._color.y), float(_OUT._color.z), float(_OUT._color.w));
    return;
} 
#endif

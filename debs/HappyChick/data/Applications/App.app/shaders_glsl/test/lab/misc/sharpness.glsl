...
void main()
{
    ...
    _OUT.VARt1 = TexCoord.xxxy + vec4(-_ps.x, 0.00000000E+00, _ps.x, -_ps.y);
    _OUT.VARt2 = TexCoord.xxxy + vec4(-_ps.x, 0.00000000E+00, _ps.x, 0.00000000E+00);
    _OUT.VARt3 = TexCoord.xxxy + vec4(-_ps.x, 0.00000000E+00, _ps.x, _ps.y);
...
void main()
{
    ...
    _TMP2 = COMPAT_TEXTURE(Texture, VARt2.xw);
    ...
    _TMP6 = COMPAT_TEXTURE(Texture, VARt1.zw);
    _color = _color - _TMP6.xyz;
    _color = _color - _TMP2.xyz;
    _color = _color - _TMP3.xyz;
    _TMP7 = COMPAT_TEXTURE(Texture, VARt3.xw);

...
void main()
{
    ...
    _TMP18._t1 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -6.50882721E-04, -1.20162964E-03, 6.50882721E-04, -1.20162964E-03);
    _TMP18._t2 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 6.50882721E-04, 1.20162964E-03, -6.50882721E-04, 1.20162964E-03);
    _TMP18._t3 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -3.25441360E-04, -6.00814819E-04, 3.25441360E-04, -6.00814819E-04);
    _TMP18._t4 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 3.25441360E-04, 6.00814819E-04, -3.25441360E-04, 6.00814819E-04);
    _TMP18._t5 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -6.50882721E-04, 0.00000000E+00, 6.50882721E-04, 0.00000000E+00);
    _TMP18._t6 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 0.00000000E+00, -1.20162964E-03, 0.00000000E+00, 1.20162964E-03);

...
void main()
{
    ...
    _TMP18._t1 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -1.04141235E-03, -1.68895721E-03, 1.04141235E-03, -1.68895721E-03);
    _TMP18._t2 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 1.04141235E-03, 1.68895721E-03, -1.04141235E-03, 1.68895721E-03);
    _TMP18._t3 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -5.20706177E-04, -8.44478607E-04, 5.20706177E-04, -8.44478607E-04);
    _TMP18._t4 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 5.20706177E-04, 8.44478607E-04, -5.20706177E-04, 8.44478607E-04);
    _TMP18._t5 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -1.04141235E-03, 0.00000000E+00, 1.04141235E-03, 0.00000000E+00);
    _TMP18._t6 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 0.00000000E+00, -1.68895721E-03, 0.00000000E+00, 1.68895721E-03);

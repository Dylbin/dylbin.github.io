...
void main()
{
    ...
    _TMP18._t1 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(-_ps.x, -_ps.y, _ps.x, -_ps.y);
    _TMP18._t2 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(_ps.x, _ps.y, -_ps.x, _ps.y);
    _TMP18._t3 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(-_sx, -_sy, _sx, -_sy);
    _TMP18._t4 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(_sx, _sy, -_sx, _sy);
    _TMP18._t5 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(-_ps.x, 0.00000000E+00, _ps.x, 0.00000000E+00);
    _TMP18._t6 = vec4(float(TexCoord.x), float(TexCoord.y), float(TexCoord.x), float(TexCoord.y)) + vec4(0.00000000E+00, -_ps.y, 0.00000000E+00, _ps.y);

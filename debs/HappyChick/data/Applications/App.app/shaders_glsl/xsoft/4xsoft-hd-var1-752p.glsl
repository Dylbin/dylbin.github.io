...
void main()
{
    ...
    _TMP18._t1 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -7.43865967E-04, -1.32942200E-03, 7.43865967E-04, -1.32942200E-03);
    _TMP18._t2 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 7.43865967E-04, 1.32942200E-03, -7.43865967E-04, 1.32942200E-03);
    _TMP18._t3 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -3.71932983E-04, -6.64710999E-04, 3.71932983E-04, -6.64710999E-04);
    _TMP18._t4 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 3.71932983E-04, 6.64710999E-04, -3.71932983E-04, 6.64710999E-04);
    _TMP18._t5 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -7.43865967E-04, 0.00000000E+00, 7.43865967E-04, 0.00000000E+00);
    _TMP18._t6 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 0.00000000E+00, -1.32942200E-03, 0.00000000E+00, 1.32942200E-03);

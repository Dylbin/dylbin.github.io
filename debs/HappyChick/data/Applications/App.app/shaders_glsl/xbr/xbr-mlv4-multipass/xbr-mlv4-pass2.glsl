...
void main()
{
    ...
    bvec4 _jag94;
    bvec4 _jag9;
    _PB = COMPAT_TEXTURE(Texture, VARt2.yw);
    _PD = COMPAT_TEXTURE(Texture, VARt3.xw);
    _PE = COMPAT_TEXTURE(Texture, VARt3.yw);
    _PF = COMPAT_TEXTURE(Texture, VARt3.zw);
    _PH = COMPAT_TEXTURE(Texture, VARt4.yw);
    _TMP0 = COMPAT_TEXTURE(OrigTexture, VARt1.xw);
    _TMP1 = COMPAT_TEXTURE(OrigTexture, VARt1.yw);
    _TMP2 = COMPAT_TEXTURE(OrigTexture, VARt1.zw);
    _TMP3 = COMPAT_TEXTURE(OrigTexture, VARt2.xw);
    _TMP4 = COMPAT_TEXTURE(OrigTexture, VARt2.yw);
    _TMP5 = COMPAT_TEXTURE(OrigTexture, VARt2.zw);
    _TMP6 = COMPAT_TEXTURE(OrigTexture, VARt3.xw);
    _TMP7 = COMPAT_TEXTURE(OrigTexture, VARt3.yw);
    _TMP8 = COMPAT_TEXTURE(OrigTexture, VARt3.zw);
    _TMP9 = COMPAT_TEXTURE(OrigTexture, VARt4.xw);
    _TMP10 = COMPAT_TEXTURE(OrigTexture, VARt4.yw);
    _TMP11 = COMPAT_TEXTURE(OrigTexture, VARt4.zw);
    _TMP12 = COMPAT_TEXTURE(OrigTexture, VARt5.xw);
    _TMP13 = COMPAT_TEXTURE(OrigTexture, VARt5.yw);
    _TMP14 = COMPAT_TEXTURE(OrigTexture, VARt5.zw);
    _TMP15 = COMPAT_TEXTURE(OrigTexture, VARt6.xy);
    _TMP16 = COMPAT_TEXTURE(OrigTexture, VARt6.xz);
    _TMP17 = COMPAT_TEXTURE(OrigTexture, VARt6.xw);
    _TMP18 = COMPAT_TEXTURE(OrigTexture, VARt7.xy);
    _TMP19 = COMPAT_TEXTURE(OrigTexture, VARt7.xz);
    _TMP20 = COMPAT_TEXTURE(OrigTexture, VARt7.xw);

...
void main()
{
    ...
    vec4 _lparam;
    vec2 _addr;
    _x0056 = TEX0.xy*OrigTextureSize;
    _TMP0 = fract(_x0056);
    ...
    _g1 = _dir*(_TMP61*VARt1.zw + _TMP69*VARt1.xy);
    ...
    _g2 = _dir*(_TMP77*VARt1.zw + _TMP85*VARt1.xy);
    _TMP5 = COMPAT_TEXTURE(OrigTexture, TEX0.xy);
    _c0094 = TEX0.xy + _g1;
    _TMP6 = COMPAT_TEXTURE(OrigTexture, _c0094);
    _c0096 = TEX0.xy + _g2;
    _TMP7 = COMPAT_TEXTURE(OrigTexture, _c0096);
    _c0098 = TEX0.xy + _g1 + _g2;
    _TMP8 = COMPAT_TEXTURE(OrigTexture, _c0098);
    _c0100 = TEX0.xy + 2.00000000E+00*_g1;
    _TMP9 = COMPAT_TEXTURE(OrigTexture, _c0100);
    _c0102 = TEX0.xy + 2.00000000E+00*_g2;
    _TMP10 = COMPAT_TEXTURE(OrigTexture, _c0102);

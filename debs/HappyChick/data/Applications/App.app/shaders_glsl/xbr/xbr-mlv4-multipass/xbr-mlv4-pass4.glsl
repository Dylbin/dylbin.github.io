...
void main()
{
    ...
    VARscale_factor = OutputSize.x/OrigInputSize.x;
    gl_Position = _r0008;
    COL0 = COLOR;
    TEX0.xy = TexCoord.xy;
} 
...
void main()
{
    ...
    vec3 _c3;
    vec3 _c4;
    _x0064 = TEX0.xy*OrigTextureSize;
    _TMP0 = fract(_x0064);
    _fp = _TMP0 - vec2( 5.00000000E-01, 5.00000000E-01);
    _x0066 = TEX0.xy*OrigTextureSize;
    _TMP1 = floor(_x0066);
    _pxcoord = _TMP1/OrigTextureSize;
    _c0068 = _pxcoord + 2.50000000E-01*VARt1.xy + 2.50000000E-01*VARt1.zw;
    _UL = COMPAT_TEXTURE(Texture, _c0068);
    _c0070 = _pxcoord + 7.50000000E-01*VARt1.xy + 2.50000000E-01*VARt1.zw;
    _UR = COMPAT_TEXTURE(Texture, _c0070);
    _c0072 = _pxcoord + 2.50000000E-01*VARt1.xy + 7.50000000E-01*VARt1.zw;
    _DL = COMPAT_TEXTURE(Texture, _c0072);
    _c0074 = _pxcoord + 7.50000000E-01*VARt1.xy + 7.50000000E-01*VARt1.zw;
    ...
    _TMP93 = floor(_x0098);
    _TMP2 = COMPAT_TEXTURE(OrigTexture, TEX0.xy);
    ...
    _c0158 = TEX0.xy + _iq.x*VARt1.xy + _iq.y*VARt1.zw;
    _TMP10 = COMPAT_TEXTURE(OrigTexture, _c0158);
    ...
    _c0216 = TEX0.xy + _iq.x*VARt1.xy + _iq.y*VARt1.zw;
    _TMP18 = COMPAT_TEXTURE(OrigTexture, _c0216);
    ...
    _c0274 = TEX0.xy + _iq.x*VARt1.xy + _iq.y*VARt1.zw;
    _TMP26 = COMPAT_TEXTURE(OrigTexture, _c0274);
    ...
    _c0332 = TEX0.xy + _iq.x*VARt1.xy + _iq.y*VARt1.zw;
    _TMP34 = COMPAT_TEXTURE(OrigTexture, _c0332);
